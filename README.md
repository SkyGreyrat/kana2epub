...
<img src="./lsimg/ls1.png" style="width:500px" class="center"></img>
2. 根据状态栏提示，点击开始按钮即可进入文件选择对话框。可以选择一个或多个文件。
<img src="./lsimg/ls2.png" style="width:500px" class="center"></img>
<img src="./lsimg/ls21.png" style="width:500px" class="center"></img>
3. 选择epub文件后程序开始运行，大约需要3-15s。视文件大小和数量而定。（此时交互界面不再响应鼠标输入）
<img src="./lsimg/ls3.png" style="width:500px" class="center"></img>
4. 提示音响起，看到状态栏提示转换完成。标注好的文件与原文件路径相同。
<img src="./lsimg/ls40.png" style="width:500px" class="center"></img>
<img src="./lsimg/ls4.png" style="width:500px" class="center"></img>
5. 若想要自定义输出路径，在点击开始前框选自定义按钮，再点击文件图标选择输出目录。
<img src="./lsimg/ls5.png" style="width:500px" class="center"></img>
